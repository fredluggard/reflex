...
function Settings() {
  ...
  return (
    ...
    <h5 className='flex justify-center md:justify-start text-base font-semibold mb-12'>Settings</h5>
    <ul className='font-semibold'>
      <li className='flex items-center mb-8'>
        <FaCog className='pr-2 w-12 md:hidden'/>
        <img src="/images/setting.png" alt="" className='hidden md:flex pr-2'/>
      ...
      <li className='flex items-center mb-8'>
        ...
        <img src="/images/profile-circle.png" alt="" className='hidden md:flex pr-2'/>
      ...
      <li className='flex items-center mb-8'>
        ...
        <img src="/images/24-support.png" alt="Support" className='hidden md:flex pr-2'/>
        <Link to='/support'
      ...
      <li onClick={handleLogout} className='flex justify-center md:justify-start items-center cursor-pointer hover:text-[#D00000]'>
        <FaSignOutAlt className='pr-2 w-12 md:hidden'/>
        <img src="/images/logout.png" alt="" className='hidden md:flex pr-2'/>
        <span>Logout</span>
      </li>
    </ul>
  </div>
