      ...
      <div className="flex flex-col justify-center">
        ...
        <div className=" hidden md:block mt-12 ">
          <div className="flex justify-evenly gap-6">
            <div className="w-[43%]">
              <div>
                <p className="font-semibold my-3 md:text-5xl">Find emergency</p>
        ...
        <div className="md:hidden px-2">
          ...
          <div className="flex h-[250px] w-screen gap-2 justify-evenly items-center">
            ...
            <div className="w-[45%] h-full bg-live-location bg-cover bg-center flex flex-col justify-center items-center text-white pt-[60px] pl-3">
              <p className="flex items-center gap-3 mb-2">
                {/* <FaLocationCrosshairs /> */}
                {`Your current GPS coordinates: ${parseFloat(
                  location.coordinates.lat
