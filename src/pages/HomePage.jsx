...
function HomePage() {
  ...
  return (
    <div className="flex flex-col justify-between relative h-[50%] md:h-full">
      <div className="flex flex-col  justify-evenly relative h-[50%] bg-mobile-bg md:bg-desktop-bg bg-cover bg-center">
        <nav>
          <NavBar />
        </nav>
