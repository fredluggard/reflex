...
function HomePage() {
  ...
  return (
    <div className="flex flex-col justify-between items-center relative h-screen">
      <div className="flex flex-col  justify-between relative h-full bg-mobile-bg md:bg-desktop-bg bg-cover bg-center">
        <nav>
          <NavBar />
        </nav>
