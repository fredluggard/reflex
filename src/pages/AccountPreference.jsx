          ...
          const response = await axios.put(
            ...
            userData,
            {
              headers: {
                ...
                'Authorization': `Bearer ${localStorage.getItem('authToken')}` // Adjust as necessary for your auth setup
              }
            }
          );
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between md:mx-16 md:my-8 text-xs md:text-base">
        ...
        <div className="md:bg-[#F5F5F5] rounded md:pt-24 md:pb-72 px-4 md:w-[70%]">
          <div className="flex justify-center md:justify-start items-center gap-4 mb-12">
            <img src="/images/profile-pic.png" alt="User profile" className='w-[15%] rounded-full' />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='mb-2'>
              ...
              <div className="flex space-x-8 items-center">
                <div className='flex items-center space-x-2'>
                    <img src="images/flag-icon.png" className='height-[20%]' alt="Flag" />
            ...
            <div className="flex w-[100%] justify-evenly space-x-12 mb-8">
              <FaCircleXmark type='button' onClick={handleCancel} className='w-8 md:hidden cursor-pointer'/>
              <button type="button" className="hidden md:flex border border-[#B33625] text-[#B33625] md:px-48 py-2 rounded-lg" onClick={handleCancel}>Cancel</button>
              <FaCircleCheck type='button' className='w-8 md:hidden cursor-pointer'/>
              <button type="submit" className="hidden md:flex border border-[#B33625] md:px-48 py-2 text-[#B33625] rounded-lg">Update</button>
            </div>
          </form>
        </div>
      </div>
